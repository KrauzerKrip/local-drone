...
public:
	...
	void renderColorStencils(ColorQuad colorQuad, const std::vector<RectangleVertices>& stencils);
	void renderImageStencils(ImageQuad imageQuad, const std::vector<RectangleVertices>& stencils);
	void frame() override;
